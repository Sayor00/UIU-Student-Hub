  ...
  return (
    <div className="relative">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/tools/cgpa-calculator">
                <Button
                  size="lg"
                  className="gap-2 shadow-lg shadow-primary/25 text-base px-8"
                >
                  ...
                  <Card className="group relative overflow-hidden border-2 hover:border-primary/40 transition-all duration-300 hover:shadow-xl hover:shadow-primary/5 cursor-pointer">
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div
                          className={`flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br ${tool.gradient} text-white shadow-lg`}
                        >
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        >
          <motion.div variants={item} className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3">Why UIU Student Hub?</h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
