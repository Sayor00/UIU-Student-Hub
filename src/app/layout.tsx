...
import MiniChatProvider from "@/components/chat/mini/MiniChatProvider";
                ...
                <div className="relative min-h-screen flex flex-col">
                  ...
                  <footer className="border-t py-4 sm:py-6 text-center text-xs sm:text-sm text-muted-foreground">
                    <div className="container mx-auto px-4 flex flex-col items-center gap-1">
                      ...
                      <a
                        href="https://github.com/TahsinFaiyaz30"
                        target="_blank"
                      ...
                      >
                        ...
                        <span className="transition-transform duration-200 group-hover/gh:translate-x-0.5">TahsinFaiyaz30</span>
                      </a>
                    </div>
                  </footer>
                </div>
