    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-4 px-4 sm:px-6">
              ...
              <div className="relative">
                <PopoverAnchor asChild>
                  <Input
                    ...
                    className={`w-full text-xs sm:text-sm ${!cardData.selectedCourse ? 'opacity-50' : ''
        ...
        {cardData.finalSection && (
          <div className={`space-y-3 p-3 sm:p-4 rounded-lg border ${isDuplicate
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div className="flex items-center gap-2 flex-wrap">
                <div className={`w-2 h-2 rounded-full flex-shrink-0 ${isDuplicate
                  ? "bg-yellow-500"
                  : uniqueConflicts.length > 0
                    ? "bg-red-500"
                    : isAlreadySelected
                ...
                <span className={`font-semibold text-sm sm:text-base ${isDuplicate
