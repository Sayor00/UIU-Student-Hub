  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/50 hover:bg-accent/60 hover:text-accent-foreground hover:border-accent-foreground/20",
        secondary:
          "bg-secondary/80 backdrop-blur-xl supports-[backdrop-filter]:bg-secondary/70 text-secondary-foreground hover:bg-secondary/60",
